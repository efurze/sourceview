...
var DATA_DIR = '/home/ec2-user/s3/repo-data-test';
...
function dir(repo) {
	return repo; //return DATA_DIR + '/' + repo;
}
...
*/
	getRevList: function(repo, branch) {
		console.log("getRevList", repo);
		branch = branch || 'master';
		var dir = repo;//DATA_DIR + '/' + repo;
...
*/
	diffSummary: function(repo, commit_list) {
		console.log("diffSummary", repo, commit_list);
		var dir = repo;//DATA_DIR + '/' + repo;
		var summaries = {};
...
*/
	sizeTree: function(repo, commit_list) {
		console.log("sizeTree", repo, commit_list);
		var dir = repo;//DATA_DIR + '/' + repo;
		var sizes = {};
		return Promise.each(commit_list, function(commit, index) {
			//console.log(index);
